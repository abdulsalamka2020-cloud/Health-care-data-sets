...
-	Which condition keeps patients in hospital the longest?
-	Most prescribed medication?
-	Which medication generate the highest revenue?
-	Condition with the highest abnormal test results?
-	Which gender is admitted through Emergency the most?
...
-	Females are the most admitted through emergencies which may be due to the facts that females are prone to diseases and abnormalities than males
...
-	More blood group A- type should be made available in the laboratories as this will save many lives because it is the most common blood type
